...
exec > >(trap "" INT TERM; sed 's/^/[MODSEC] /')
set -ex
echo INSTALLING DEPENDENCIES
apt-get install bison build-essential ca-certificates curl dh-autoreconf \
        ...
        libxml2 libxml2-dev libyajl-dev locales lua5.3-dev pkg-config wget zlib1g-dev zlibc
