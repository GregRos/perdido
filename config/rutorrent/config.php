...
$do_diagnostic = true;
$log_file = '/var/rutorrent/rutorrent.log';          // path to log file (comment or leave blank to disable logging)
...
//
$scgi_port = 0;
$scgi_host = "unix:///var/rtorrent/session/scgi.socket";
...
$profilePath = '/var/rutorrent/profiles/';           // Path to user profiles
